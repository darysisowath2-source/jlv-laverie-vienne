# Démo client — Laverie Hoche (Limoges)
...
Base réutilisée du site Laverie du Cygne, identité visuelle propre : palette **porcelaine de Limoges** (blanc cassé, bleu cobalt #1e3a8a, or #b8922a), fonts **Playfair Display + DM Sans**, orbs cobalt/or animés, filet d'or décoratif façon porcelaine. RDV prospect prévu (annoncé la veille).

## Client

- **Nom** : Laverie Hoche
- **Adresse** : 59 rue Hoche, 87100 Limoges (confirmée web)
- **Ville** : Limoges, plein centre
- **Secteur** : laverie automatique
- **Site actuel** : aucun
- **Note** : bien notée Google (sources divergentes, 4 à 5/5)

## À CONFIRMER avec le prospect (placeholders flaggés)

- Téléphone (05 55 00 00 00 = PLACEHOLDER, aucun tel public trouvé)
- Horaires exacts (mis 7h-22h, à valider)
- Tarifs réels des machines (estimations)
- Capacités machines, lessive incluse ou vendue
- Email de contact, photos réelles (remplacer Unsplash)
